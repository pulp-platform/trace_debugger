* TRDB -- Trace Debugger For RISC-V Core
** Overview
...
** Dependencies for TRDB
   ...
   binutils built using [[https://github.com/pulp-platform/pulp-riscv-binutils-gdb][binutils]] with the =trace_dbg_dev= branch. Build it by
   calling
   #+BEGIN_SRC bash
